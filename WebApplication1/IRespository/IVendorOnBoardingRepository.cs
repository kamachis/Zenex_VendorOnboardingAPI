...
namespace Zenex.Registration.IRespository
{
    public interface IVendorOnBoardingRepository
    {
        ...
        List<BPVendorOnBoardingWithSapTransID> GetAllApprovedVendorOnBoardings();
        List<BPVendorOnBoarding> GetAllRejectedVendorOnBoardings();
        List<BPVendorOnBoarding> GetAllOpenVendorOnBoardingsCount();
        Task<AccountCode> GetCompanyAndAccount();
        Task<bool> WelcomeMail(VendorDetailsSample vendordetails);
       ...
       // List<BPVendorOnBoarding> GetAllOpenVendorOnBoardingsByPlant(List<string> Plants);
        ...
        List<BPVendorOnBoarding> GetAllOpenVendorOnBoardingsByPending(string  Pending);
       ...
       // List<BPAttachment1> bank_doc(int TransID, string Accono);
        ...
        Task<bool> UpdateVendorOnBoarding(BPVendorOnBoardingView VendorOnBoardingView);
