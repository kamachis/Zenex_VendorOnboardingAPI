...
namespace Zenex.Controllers
{
    ...
    public class VendorMasterController : Controller
    {
            ...
            private readonly IRegisterIdentityRepository _IdentityRepository;
            private readonly IIdentityRepository _documentidentityrespository;
            private readonly IRegisterBankRepository _BankRepository;
            ...
            public VendorMasterController(IIdentityRepository documentidentityrespository,ITypeRepository typeRepository, IPostalRepository PostalRepository, IRegisterIdentityRepository IdentityRepository, IRegisterBankRepository BankRepository,
            ...
            _documentidentityrespository = documentidentityrespository;
            }
        [HttpGet]
        ...
        public async Task<IdentityAttachments> GetIdentitiesDeleteByVOB(int TransID, string Doctype)
        {
            try
            {
                var Identitys = await _documentidentityrespository.GetIdentitiesDeleteByVOB(TransID, Doctype);
                return Identitys;
            }
            catch (Exception ex)
            {
        ...
        public List<IdentityAttachments> GetIdentitiesByVOB(int TransID)
        {
            try
            {
                var Identitys = _documentidentityrespository.GetIdentitiesByVOB(TransID);
                return Identitys;
            }
            catch (Exception ex)
            {
