...
namespace Zenex.Controllers
{
    ...
    public class MasterController : Controller
    {
            ...
            public async Task<IActionResult> CreateUser(UserWithRole userWithRole)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            return BadRequest("Username or Mail already exist");
                        }
            ...
            //[HttpPost]
            //public async Task<IActionResult> CreateApproverUser(Authentication.Models.AuthMaster.ApproverUser approverUser)
            //{
            //    try
            //    {
            //        if (!ModelState.IsValid)
        ...
        public async Task<bool> changepassword(ForgotPasswordModel ForgotPassword)
        {
            ...
            try
            {
                var result = await _masterRepository.changepassword(ForgotPassword);
                return result;
