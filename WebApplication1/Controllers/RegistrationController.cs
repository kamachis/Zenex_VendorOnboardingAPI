...
namespace Zenex.Controllers
{
    ...
    public class RegistrationController : ControllerBase
    {
        ...
        [HttpGet]
        public List<BPVendorOnBoarding> GetAllPendingVendorOnBoardings(string Approver)
        {
            try
            {
        ...
        public async Task<IActionResult> UpdateVendorOnBoarding(BPVendorOnBoardingView VendorOnBoarding)
        {
            try
            {
                ...
                var result = await _VendorOnBoardingRepository.UpdateVendorOnBoarding(VendorOnBoarding);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        //public async Task<bool> CreateBank( BPBank bpbank)
        //{
        //    var result = await _BankRepository.CreateBanks(bpbank);
        //    return result;
        //}
        ...
        //        var bank1 = _VendorOnBoardingRepository.bank_doc(TransID, bank[0].AccountNo);
        ...
        //            writer.WriteElementString("AddressLine1", bPVendorOnBoarding.AddressLine1);
        //            writer.WriteElementString("AddressLine2", bPVendorOnBoarding.AddressLine2);
        //            writer.WriteElementString("AddressLine3", bPVendorOnBoarding.AddressLine3);
        //            writer.WriteElementString("AddressLine4", bPVendorOnBoarding.AddressLine4);
        //            writer.WriteElementString("AddressLine5", bPVendorOnBoarding.AddressLine5);
        ...
        //            writer.WriteElementString("PRIMARYCONTACT", bPVendorOnBoarding.PrimaryContact ?? "");
        //            writer.WriteElementString("SECONDARYCONTACT", bPVendorOnBoarding.SecondaryContact ?? "");
        //            writer.WriteElementString("PRIMARYEMAIL", bPVendorOnBoarding.Primarymail ?? "");
        //            writer.WriteElementString("SECONDARYEMAIL", bPVendorOnBoarding.Secondarymail ?? "");
        ...
        //        return CreatedAtAction(nameof(GetAllContacts), new { TransID = Contact.TransID, Item = Contact.Name }, Contact);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        {
          var details = await _VendorOnBoardingRepository.GetCompanyAndAccount();
        ...
        {
            var details = _IdentityRepository.GetGstDetails();

            return details;

        }
        [HttpPost]
        public Task<bool> WelcomeMail(VendorDetailsSample vendordetails)
        {
            var  details = _VendorOnBoardingRepository.WelcomeMail(vendordetails);
            return details;
        }
    }
}
